				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="post-header">
						...
						<?php if ( get_the_title() ) : ?>
						    ...
						    <h1 class="post-title" style="margin-top:50px"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
					...
					<div class="post-meta" style="width:40%;height: 300px">
