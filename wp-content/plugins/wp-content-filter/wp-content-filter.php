...
function pccf_plugin_settings_link( $links, $file ) {
	...
	if ( $file == plugin_basename( __FILE__ ) ) {
		$pccf_links = '<a style="color:#d54e21;" href="https://wpgoplugins.com/plugins/content-censor/" target="_blank" title="Go PRO - 100% money back guarantee"><span class="dashicons dashicons-megaphone"></span></a>';
